...
class Spin:
    ...
    def spin_vector(self, arr, radius, desc):
        ...
        # Sanity check plot
        """v = np.linalg.norm((arr['Velocity'] - self.centre_vel)*u.Mpc.to(u.km), axis=1)
...
if __name__ == '__main__':
    ...
    plt.savefig("/Users/c22048063/Documents/EAGLE/trial_plots/Misalignment_angle%s.jpeg"%str(mySims[0][1]), format='jpeg', bbox_inches='tight', pad_inches=0.2, dpi=300)
    plt.close()
